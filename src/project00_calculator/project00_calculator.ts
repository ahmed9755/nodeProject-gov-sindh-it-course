...
switch (userReply.operators) {
  case "Add":
    ...
    console.log(
      chalk.greenBright.bold(
        `The sum of : ${userReply.numb1} and ${userReply.numb2} = ${add}`
      )
    );
  ...
  case "Subtract":
    ...
    console.log(
      chalk.greenBright.bold(
        `The subtraction of : ${userReply.numb1} and ${userReply.numb2} = ${sub}`
      )
    );
    console.log(chalk.bgBlueBright.bold("\n\t\**********Thank You For using CLI Calculator**********\t\n"));
    break;
  case "Multiply":
    ...
    console.log(
      chalk.greenBright.bold(
        `The Multiplication of : ${userReply.numb1} and ${userReply.numb2} = ${mul}`
      )
    );
    console.log(chalk.bgBlueBright.bold("\n\t\**********Thank You For using CLI Calculator**********\n\t"));
    break;
  case "Divide":
    ...
    console.log(
      chalk.greenBright.bold(
        `The Division of : ${userReply.numb1} and ${userReply.numb2} = ${div}`
      )
